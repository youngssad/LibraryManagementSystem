                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td colspan="2" valign="top">
                                <marquee><h3 style="margin:20px 0 10px 10px;">Thank you for using Library Management System</h3>  </marquee>
                            </td>
                        </tr>
                            ...
                            <td valign="top">
                                <table width="100%" height="230" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #CCCCCC;">
                                    ...
                                    <tr><td height="186" valign="top"  style="font-size: 20px; font-family:'隶书'; font-weight: bolder;">
                                        ...
                                        <img src="Images/book.jpg" width="700px" height="500px"/>

                                    </td>
                                    <td>&nbsp;&nbsp;</td>
                                    <td height="102" valign="top">
                                        <img src="Images/book1.jpg" width="700px" height="500px"/>
                                    </td></tr>
